...
st.dataframe(vtasutures.style.highlight_max(axis=0), width=1500, height=800)
...
fig0.update_layout(height=800, width=1200, title_text=f"Total Sutures Monthly Sales in Soles")
st.write(fig0)
